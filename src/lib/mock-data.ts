...
export const MOCK_COURSES: Course[] = [
  ...
  },
  {
    ...
    subtitle: "6 modules, 3 h, MCPs, agents persistants",
    description:
...
export const MOCK_MODULES: Record<string, Module[]> = {
  ...
  "cours-02": [
    ...
    },
    {
      id: "mod-2-3",
      course_id: "course-02",
      slug: "pipeline-lead-mail",
      title: "Pipeline lead, mail, relance, en 1 après-midi",
      subtitle: "Du formulaire au CRM : capture, enrichissement, séquence",
      description: "20 min, 1 pipeline complet à répliquer",
      order_index: 3,
      video_url: null,
      content_md: null,
      duration_min: 20,
    ...
    },
    {
      id: "mod-2-4",
      course_id: "course-02",
      slug: "mcps-strategiques",
      title: "Les 8 MCPs stratégiques",
      subtitle: "Brancher l'IA sur vos outils : lecture, écriture, garde-fous",
      description: "20 min, 8 connexions passées en revue",
      order_index: 4,
      video_url: null,
      content_md: null,
      duration_min: 20,
    ...
    },
    {
      id: "mod-2-5",
      course_id: "course-02",
      slug: "workflows-business",
      title: "10 workflows business clés-en-main",
      subtitle: "Prospection, contenu, support, admin : à copier tel quel",
      description: "28 min, 10 workflows livrés",
      order_index: 5,
      video_url: null,
      content_md: null,
      duration_min: 28,
    ...
    },
    {
      ...
      subtitle: "Mettre en prod sans se faire peur : alertes, coûts, RGPD",
      description: "16 min, checklist de mise en production",
      order_index: 6,
      video_url: null,
      content_md: null,
      duration_min: 16,
