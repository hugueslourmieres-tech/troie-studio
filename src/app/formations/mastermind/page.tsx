...
export const metadata = {
  title: "Mastermind TROIE · L'abo qui garde votre stack IA a jour — TROIE",
  description:
...
const RYTHMES = [
  {
    ...
    body: "10 nouveaux prompts metier ajoutes a la bibliotheque (selon votre vertical : marketing, ops, sales, content).",
  },
  {
    title: "Chaque mois",
    body: "Office hours live 1 h. Demos, refonte de cas, Q&A. Replays disponibles a tout moment.",
  },
  {
    title: "A chaque release",
    body: "Mises a jour des supports cours 24 h apres un nouveau modele (GPT 6, Claude Opus 5, Gemini 3.5...).",
  },
  {
    title: "En continu",
    body: "Discord prive actif : entraide, partage de workflows, retours d'experience reel.",
  },
];

const INCLUDED = [
  {
    title: "Cours 01 · Maitriser ChatGPT & Claude",
    body: "97 € inclus. 4 modules + 25 prompts livres. Acces a vie.",
  },
  {
    title: "Cours 02 · Workflows IA solo & equipe",
    body: "297 € inclus. 7 modules + 100 prompts + 10 templates + 3 agents. Acces a vie.",
  },
  {
    title: "Bibliotheque vivante de prompts",
    body: "500+ prompts metier maintenus a jour. Tag par cas d'usage, par outil, par vertical.",
  },
  {
    title: "Veille IA mensuelle",
    body: "1 brief synthese par mois : releases majeures, nouveaux MCPs, evolutions tarifaires, ce qui marche reellement.",
  },
  {
  ...
  {
    title: "Discord prive",
    body: "Communaute de pros : freelances, equipes, marques. Entraide, partage, jobs board.",
  },
];
...
const FAQ = [
  {
    ...
    a: "Vous economisez deja 97 + 297 = 394 € avec le cumul des deux cours (vs 588 € si pris a l'unite). Le plus important : vous restez aligne sur la meta du moment. L'IA bouge vite, un cours achete il y a 6 mois peut etre depasse sur certains outils. Le Mastermind garantit que votre stack reste pertinente.",
  },
  {
    q: "Puis-je annuler quand je veux ?",
    a: "Oui, en 1 clic dans votre espace membre. L'abonnement mensuel s'arrete a la fin du mois en cours, pas de prelevement supplementaire. L'annuel : remboursement au prorata des mois non consommes pendant les 30 premiers jours.",
  },
  {
    q: "Mensuel ou annuel : que choisir ?",
    a: "Si vous testez : mensuel. Si vous etes deja convaincu et voulez optimiser : annuel (2 mois offerts, 490 € soit 41 €/mois equivalent). Vous pouvez switcher du mensuel a l'annuel a tout moment.",
  },
  {
    q: "Pour qui n'est-ce PAS fait ?",
    a: "Pour quelqu'un qui veut juste un cours one-shot sans suivi : achetez Cours 01 ou 02 a l'unite. Pour quelqu'un qui veut une formation certifiante CPF : pas encore (Qualiopi en cours). Pour quelqu'un qui veut du coaching individuel : voir l'audit gratuit + accompagnement TROIE IA Pro.",
  },
  {
    q: "Combien etes-vous a l'inscription ?",
    a: "Petite communaute volontairement limitee a 100 membres actifs pour garder la qualite des office hours et l'attention sur chaque cas. Si plein : liste d'attente avec acces au cours 01 inclus en attendant.",
  },
];
    ...
    <article className="min-h-screen bg-[var(--bg)] text-[var(--fg)]">
          ...
          <div className="grid gap-16 md:grid-cols-12 md:gap-12 lg:gap-20">
            <div className="md:col-span-7">
              ...
              <h1 className="t-display mt-8 text-5xl text-[var(--fg)] md:text-6xl lg:text-[80px]">
                L'abo qui garde{" "}
                <span className="text-[var(--accent)]">votre stack a jour.</span>
              </h1>
              ...
              <div className="rounded-sm border border-[var(--accent)] bg-[var(--accent)] p-6 text-[#1a1714] md:p-8">
                ...
                <ul className="mt-6 space-y-2.5">
                  {[
                    "Cours 01 (97 €) inclus",
                    "Cours 02 (297 €) inclus",
                    "Bibliotheque 500+ prompts vivante",
      ...
      <section className="border-t border-[var(--rule)] bg-[var(--bg-2)]">
        <div className="mx-auto max-w-7xl px-6 py-24 md:px-12 md:py-36">
          ...
          <h2 className="t-display mt-8 max-w-3xl text-4xl text-[var(--fg)] md:text-5xl lg:text-6xl">
            Un rythme calibre pour rester en avance.
          </h2>
      ...
      <section className="border-t border-[var(--rule)]">
        <div className="mx-auto max-w-7xl px-6 py-24 md:px-12 md:py-36">
          ...
          <h2 className="t-display mt-8 max-w-3xl text-4xl text-[var(--fg)] md:text-5xl lg:text-6xl">
            394 € de cours offerts, et la suite a vie.
          </h2>
          <p className="mt-10 max-w-2xl text-base leading-relaxed text-[var(--fg-2)] md:text-lg">
            Si vous comptiez acheter Cours 01 + Cours 02 a l'unite (394 €), l'abonnement est rentable des le mois 1. Et apres, c'est tout le reste qui compte.
          </p>
          ...
          <div className="grid gap-16 md:grid-cols-12 md:gap-20">
            <div className="md:col-span-8">
              ...
              <p className="mt-8 max-w-2xl text-base leading-relaxed text-[var(--fg)]/85 md:text-lg">
                Communaute volontairement limitee a 100 membres actifs. Vos cas trouvent une vraie reponse en live, pas un thread perdu.
              </p>
              <div className="mt-12 flex flex-wrap items-center gap-x-8 gap-y-4">
                <a
                  href={SUBSCRIBE_MONTHLY}
            ...
            <div className="md:col-span-4 md:border-l md:border-[var(--fg)]/20 md:pl-12">
              ...
              <p className="mt-3 text-sm leading-relaxed text-[var(--fg)]/75">
                Gratuit. On voit si l'abo vaut le coup pour vous, ou s'il vaut mieux 1 cours a l'unite.
              </p>
            </div>
          </div>
        </div>
