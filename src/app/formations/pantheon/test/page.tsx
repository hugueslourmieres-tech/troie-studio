...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://troiestudio.fr/formations/pantheon/test" },
  openGraph: {
    type: "website",
    url: "https://troiestudio.fr/formations/pantheon/test",
 ...
 * repart avec un parcours taillé pour son usage. Le contexte complet
 * (ce que sont les maisons, chiffres, outils) vit sur /formations/pantheon.
 */
export default function PantheonTestPage() {
  return (
