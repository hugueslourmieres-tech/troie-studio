...
/** Behance — PNG asset rendered with currentColor via CSS mask, so it
 * inherits the link colour like the SVG icons do. */
function BehanceIcon() {
  return (
    <span
      ...
      style={{
        WebkitMaskImage: "url(/images/brand/behance.png)",
        maskImage: "url(/images/brand/behance.png)",
